...
static cl::opt<bool> EnableStringObfuscation(
    "stringobf", cl::init(false),
    cl::desc("Enable string obfuscation"));

static cl::opt<bool> EnableInstructionObfuscation(
    "instrobf", cl::init(false),
    cl::desc("Enable instruction obfuscation"));
...
static cl::opt<bool> EnableIndirectBranch(
    "indirbr", cl::init(false),
